        ...
        <div className='row dv '>
          <div className='col-2 ps-4 '>
            <ul className=' flex-column'>
              ...
              <li className=''><NavLink className='li d-flex' to="/Subscriptions"><BsFiles className='me-2' />Subscriptions</NavLink></li>
            </ul>
            <ul className='mt-5 mb-5 flex-column'>
              <li className=''><NavLink className='li d-flex' to='/Home'><SlFolder className='me-2' />Library</NavLink></li>
              <li className='my-3'><NavLink className='li d-flex' to="/Trending"><MdOutlineListAlt className='me-2' />History</NavLink></li>
              <li className=''><NavLink className='li d-flex' to="/Subscriptions"><BsAlarm className='me-2' />Watch later</NavLink></li>
              <li className='my-3'><NavLink className='li d-flex' to="/Subscriptions"><AiOutlineStar className='me-2' />Favourites</NavLink></li>
              <li className=''><NavLink className='li d-flex' to="/Subscriptions"><BsSuitHeart className='me-2' />Liked videos</NavLink></li>
